...
public class Churn {
  ...
  public static class TokenizerMapper 
    ...
    public void map(Object key, Text value, Context context
      ...
      String churn = toks[toks.length-1];
      if(churn.equals("Yes")){
        int tenure = Integer.parseInt(toks[5]);
        String internetService = toks[8];
        System.out.println(internetService+": "+tenure);
        context.write(new Text(internetService), new IntWritable(tenure));
      }
  ...
  public static class IntSumReducer 
    ...
    public void reduce(Text key, Iterable<IntWritable> values, 
      ...
      if(count>200){
        System.out.println(key+": "+maxValue+" count:"+count);
